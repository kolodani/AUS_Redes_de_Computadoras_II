...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.138 2025-05-01 17:49:26 GMT")
...
{	struct ns2__add soap_tmp_ns2__add;
	...
	soap_tmp_ns2__addResponse.result = &soap_tmp_double;
...
{	struct ns2__sub soap_tmp_ns2__sub;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns2__subResponse.result = &soap_tmp_double;
...
{	struct ns2__mul soap_tmp_ns2__mul;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns2__mulResponse.result = &soap_tmp_double;
...
{	struct ns2__div soap_tmp_ns2__div;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns2__divResponse.result = &soap_tmp_double;
...
{	struct ns2__pow soap_tmp_ns2__pow;
	...
	soap_default_double(soap, &soap_tmp_double);
	soap_tmp_ns2__powResponse.result = &soap_tmp_double;
